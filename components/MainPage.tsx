  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-pink-50 to-blue-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-6">
        {/* Face Swap Card */}
        <div className="bg-gradient-to-br from-pink-100 to-pink-200 rounded-3xl p-8 shadow-xl transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div className="space-y-2">
              <h2 className="text-2xl font-bold text-gray-800">AI얼굴변환</h2>
            ...
            <button
              ...
              className="group relative px-8 py-3 bg-gradient-to-r from-pink-500 to-pink-600 text-white font-bold rounded-full shadow-lg transform transition-all duration-300 hover:shadow-xl hover:scale-105"
            >
        ...
        {/* Video Swap Card */}
        <div className="bg-gradient-to-br from-blue-100 to-blue-200 rounded-3xl p-8 shadow-xl transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
          <div className="flex flex-col items-center text-center space-y-4">
            <div className="relative">
              <div className="absolute inset-0 bg-white rounded-2xl blur-xl opacity-50"></div>
              <div className="relative w-48 h-48 flex items-center justify-center">
                <div className="w-32 h-44 bg-gradient-to-br from-cyan-300 to-cyan-400 rounded-2xl shadow-lg transform rotate-6 transition-transform duration-300 hover:rotate-12">
            ...
            <button
              ...
              className="group relative px-8 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-bold rounded-full shadow-lg transform transition-all duration-300 hover:shadow-xl hover:scale-105"
            >
              <span className="relative z-10">시작하기 &gt;</span>
